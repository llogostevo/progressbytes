...
function AssessmentModal() {
    ...
    return (
        <div>
            <button className="border border-primaryColor hover:bg-secondaryColor hover:border-secondaryColor hover:text-white text-primaryColor font-bold py-2 px-4 rounded" onClick={handleOpen}>Open Judgement Guidance</button>
            {isOpen && (
                <div>
                    {isOpen && (
