...
export default async function TeacherAssessmentClasses({ params }: { params: { schoolclassesslug: number } }) {
...
<h1 className="text-4xl font-semibold mb-4">Class Assessments</h1>
