            ...
            <div className="mt-10 flex flex-col gap-4 text-center">
              <div className="flex">
                <Link
                  ...
                  className="flex-grow inline-block border border-primaryColor text-center hover:bg-tertiaryColor hover:text-white hover:border-white text-primaryColor rounded px-4 py-2 transition duration-200"
                >
                  Class Assessments
                </Link></div>
            </div>
