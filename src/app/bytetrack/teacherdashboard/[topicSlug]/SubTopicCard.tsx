/*
This is the subtopic card
this has pulls in the subtopic name from the previously clicked dataset, unit, total marks etc to calculate the detail for the topic
This Works
*/
...
export default function SubTopicCard({
  ...
  totalMarksAchieved,
  totalMarks,
  numberOfStudents }: SubTopicCardProps) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold truncate">{subTopicName}</h2>
